...
from network.graph import GraphTripleConv, GraphTripleConvNet
from network.layout import boxes_to_layout, masks_to_layout
from network.layers import build_mlp
from network.pix2pix import networks
...
class Sg2ImModel(nn.Module):
  def __init__(self, vocab, image_size=(64, 64), embedding_dim=64,
               ...
               ngf = 64, netG = 'global', n_downsample_global=3, n_blocks_global=9, n_local_enhancers=1, 
               n_blocks_local=3, **kwargs):
    ...
    refinement_kwargs = {
      'input_nc': (gconv_dim + layout_noise_dim),
      'output_nc': 3,
      'ngf': ngf,
      'netG': netG,
    ...
    self.refinement_net = networks.define_G(**refinement_kwargs)
  ...
  def forward(self, objs, triples, obj_to_img=None,
    ...
    return img, boxes_pred, masks_pred, rel_scores, ret_layout
